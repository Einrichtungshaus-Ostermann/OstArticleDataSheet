...
namespace OstArticleDataSheet;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstArticleDataSheet extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_article_data_sheet.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_article_data_sheet.view_dir', $this->getPath() . '/Resources/views/');
